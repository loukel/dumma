...
const TeamCard = ({name, role, imgFile, description, facebook, instagram}) => {
  return ( 
    <div className="p-4 lg:w-1/2">
      <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
        <img alt="profile" className="flex-shrink-0 rounded-lg w-60 h-60 object-cover object-center sm:mb-0 mb-4" src={imgFile ? `/resources/${imgFile}` : 'https://dummyimage.com/200x200'} />
